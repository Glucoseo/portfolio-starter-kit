  ...
  return (
    <section>
      ...
      <p className="mb-4">
        ...
        Currently i'm making projects for my CVs, portfolio, Github, to gain experience in Next.js.(I NEED TO CHANGE BLOG INTO "MY THOUGHTS")
        I appreciate any tip in my learning path, so any advice would be great.
        I hope that in the future i would inspire and teach someone.`}
      </p>
      <div className="my-8">
{/*  <BlogPosts /> */}        
      </div>
